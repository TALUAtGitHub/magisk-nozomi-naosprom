...
echo ""
echo "This script is untested on the Sony Xperia Arco S (though it may work on that device) and other ROMs such as older nAOSProm ROMs (though it may still work on those older ROMs)."
echo ""
echo "** Requirements: **"
